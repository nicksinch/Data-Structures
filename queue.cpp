...
void Queue<T>::Push(const T & Element)
{
    ...
    Size++;
    /*
        Without the above if (whether Queue is empty or not) , with the next line, we make it circular queue.
        This means that when the Queue becomes full , we start pushing at the front again.
    */
    //Back = Back % MAX_SIZE;
}
